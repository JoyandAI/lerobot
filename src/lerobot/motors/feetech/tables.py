...
# http://doc.feetech.cn/#/f?q=250689e628d7
HLS_SERIES_CONTROL_TABLE = {
    ...
    "Homing_Offset": (31, 2),
    "Operating_Mode": (33, 1),
    "Current_Loop_P_Coefficient": (34, 1),
    "Current_Loop_I_Coefficient": (35, 1),
    "Velocity_closed_loop_P_proportional_coefficient": (37, 1),
    "Over_Current_Protection_Time": (38, 1),
    "Velocity_closed_loop_I_integral_coefficient": (39, 1),
    # SRAM control
    ...
    "Status": (65, 1),  # read-only
    "Moving": (66, 1),  # read-only
    "Goal_Position_2": (67, 2),  # read-only
    "Present_Current": (69, 2),  # read-only
    "Current_Offset": (73, 2),  # read-only
    # Factory
    "vFk*10": (77, 1),
    "vKgI": (78, 1),
    "pFk*10": (79, 1),
...
MODEL_CONTROL_TABLE = {
    ...
    "hls_series": HLS_SERIES_CONTROL_TABLE,
    ...
    "hls3915m": HLS_SERIES_CONTROL_TABLE,
}
